        ...
        <div className="machined-panel px-6 py-3 flex items-center justify-between w-full max-w-6xl pointer-events-auto shadow-2xl">
          ...
          <div className="flex items-center gap-4">
            ...
            <button
              ...
              className="magnetic-btn bg-zinc-950 text-white px-6 py-2.5 rounded-lg text-xs font-bold uppercase tracking-widest hover:bg-amber-400 transition-colors shadow-md">
      ...
      <main className="relative w-full overflow-x-hidden">
        ...
        <section className="relative min-h-screen flex items-center pt-32 pb-20 px-6 max-w-7xl mx-auto overflow-hidden z-10 perspective-container">
          <div className="grid lg:grid-cols-2 gap-12 items-center w-full">
            <div className="max-w-2xl parallax-layer" data-speed="0.05">
              ...
              <div className="reveal-3d flex flex-wrap items-center gap-4" style={{ transitionDelay: '0.5s' }}>
                <button
                  onClick={() => navigate('/dashboard')}
                  className="magnetic-btn bg-zinc-950 text-white px-8 py-4 rounded-xl font-black text-sm uppercase tracking-widest shadow-xl hover:bg-amber-400 transition-colors">
                  <span className="magnetic-btn-inner flex items-center gap-2">Open Dashboard</span>
                </button>
                <button className="magnetic-btn machined-panel text-zinc-950 px-8 py-4 rounded-xl font-black text-sm uppercase tracking-widest hover:bg-white transition-colors">
                  <span className="magnetic-btn-inner flex items-center gap-2">▶ Watch 2-Min Demo</span>
                </button>
              </div>
            ...
            <div ref={heroRef} className="reveal-3d relative h-[500px] flex items-center justify-center">
              <div className="relative w-full h-full flex items-center justify-center">
                ...
                <div className="coil-ring w-[380px] h-[380px] border-zinc-300/60 animate-[rotate-ccw_35s_linear_infinite]" style={{ transform: 'translateZ(30px)' }}>
                    <div className="absolute bottom-1/4 right-0 w-4 h-4 bg-amber-400 rounded-full shadow-[0_0_20px_rgba(212,175,55,0.8)]"></div>
        ...
        <section className="py-32 px-6 max-w-7xl mx-auto text-center relative z-10" id="features-section">
          <div className="reveal-3d mb-6 flex flex-col items-center">
            <div className="inline-flex items-center gap-2 bg-emerald-50 border border-emerald-200 text-emerald-700 text-[11px] font-black uppercase tracking-[0.2em] px-4 py-2 rounded-full mb-6">
            ...
            <h2 className="text-5xl md:text-6xl font-black tracking-[-0.03em] text-zinc-950 mb-5 uppercase leading-[1.0]">
              ...
              <span style={{ background: 'linear-gradient(135deg, #1F8A70 0%, #0F3D3E 100%)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent' }}>
                Platform.
              </span>
            </h2>
          ...
          <div className="reveal-3d flex items-center justify-center gap-2 text-[11px] text-zinc-400 font-bold uppercase tracking-widest mb-14" style={{ transitionDelay: '0.15s' }}>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5" id="feature-cards-grid">
            {[
              {
        ...
        <section className="py-24 px-6 max-w-7xl mx-auto relative z-10 perspective-container">
            <div className="grid lg:grid-cols-2 gap-16 items-start">
                {/* Left Text Content */}
                <div className="order-2 lg:order-1 reveal-3d parallax-layer pt-4" data-speed="0.02">
                    <div className="text-xs uppercase tracking-[0.25em] text-emerald-600 font-black mb-4">Voice AI Technology</div>
                    <h2 className="text-4xl md:text-5xl font-black tracking-tighter text-zinc-950 mb-12 uppercase leading-[1.1]">
                        Call every lead,<br/>
                ...
                <div className="order-1 lg:order-2 reveal-3d parallax-layer" data-speed="0.02">
                    <div className="bg-zinc-950 rounded-[32px] p-4 shadow-[0_20px_60px_rgba(15,61,62,0.3)] border border-zinc-800 flex flex-col relative overflow-hidden transform-style-3d mockup-float min-h-[500px] h-auto">
                        {/* Header */}
                        ...
                        <div className="flex-1 bg-zinc-950 rounded-b-2xl p-6 flex flex-col relative overflow-hidden">
                            ...
                            <div className="relative z-20 mt-6 mockup-child mockup-child-4">
                                <button className="magnetic-btn w-full bg-emerald-950/40 border border-emerald-900 hover:bg-emerald-900/60 transition-colors py-4 rounded-xl flex items-center justify-center gap-2 text-sm font-bold text-emerald-400 shadow-inner uppercase tracking-widest">
        ...
        <section className="py-32 px-6 max-w-7xl mx-auto relative z-10 perspective-container">
            <div className="reveal-3d mb-16 flex flex-col md:flex-row md:items-end justify-between gap-8 parallax-layer" data-speed="0.02">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div className="machined-panel p-8 reveal-3d group flex flex-col">
                    <div className="text-xs font-black text-amber-500 uppercase tracking-widest mb-4">&lt; 5 min avg first call</div>
                    <h3 className="text-2xl font-black text-zinc-950 tracking-tighter mb-2 uppercase">Automated Outbound Calling</h3>
                    <p className="text-zinc-600 font-medium text-sm leading-relaxed">Reach every lead within minutes. Handles scheduling, retries, and call windows—zero manual dialing.</p>
                </div>

                <div className="machined-panel p-8 reveal-3d group flex flex-col" style={{ transitionDelay: '0.1s' }}>
                    <div className="text-xs font-black text-emerald-600 uppercase tracking-widest mb-4">4 signals per call</div>
                    <h3 className="text-2xl font-black text-zinc-950 tracking-tighter mb-2 uppercase">BANT Qualification Scoring</h3>
                    <p className="text-zinc-600 font-medium text-sm leading-relaxed">Each call is scored across Budget, Authority, Need, and Timeline with full audit trails.</p>
                </div>

                <div className="machined-panel p-8 reveal-3d group flex flex-col" style={{ transitionDelay: '0.2s' }}>
                    <div className="text-xs font-black text-amber-500 uppercase tracking-widest mb-4">&lt; 1 sec sync latency</div>
                    <h3 className="text-2xl font-black text-zinc-950 tracking-tighter mb-2 uppercase">CRM Sync & Webhooks</h3>
                    <p className="text-zinc-600 font-medium text-sm leading-relaxed">Push qualified lead data directly to Salesforce, HubSpot, or Pipedrive the moment a call completes.</p>
                </div>

                <div className="machined-panel p-8 reveal-3d group flex flex-col" style={{ transitionDelay: '0.3s' }}>
                    <div className="text-xs font-black text-emerald-600 uppercase tracking-widest mb-4">Real-time dashboards</div>
                    <h3 className="text-2xl font-black text-zinc-950 tracking-tighter mb-2 uppercase">Pipeline Analytics</h3>
                    <p className="text-zinc-600 font-medium text-sm leading-relaxed">Track conversion rates, call volumes, and qualification trends. Understand exactly where leads drop off.</p>
                </div>

                <div className="machined-panel p-8 reveal-3d group flex flex-col" style={{ transitionDelay: '0.4s' }}>
                    <div className="text-xs font-black text-amber-500 uppercase tracking-widest mb-4">No-code configuration</div>
                    <h3 className="text-2xl font-black text-zinc-950 tracking-tighter mb-2 uppercase">Configurable Rules</h3>
                    <p className="text-zinc-600 font-medium text-sm leading-relaxed">Set calling windows, retry delays, score thresholds, and SLA targets through a simple admin interface.</p>
                </div>

                <div className="machined-panel p-8 reveal-3d group flex flex-col" style={{ transitionDelay: '0.5s' }}>
                    <div className="text-xs font-black text-emerald-600 uppercase tracking-widest mb-4">SOC 2 Type II certified</div>
                    <h3 className="text-2xl font-black text-zinc-950 tracking-tighter mb-2 uppercase">Compliance Built In</h3>
                    <p className="text-zinc-600 font-medium text-sm leading-relaxed">DND checks, consent management, call time restrictions, and auto-deletion of recordings after 90 days.</p>
                </div>
            </div>
        </section>
        ...
        <section className="py-32 px-6 max-w-7xl mx-auto relative z-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-5xl mx-auto reveal-3d">
            <div className="machined-panel p-10 flex flex-col h-full bg-white/80">
              ...
              <button className="magnetic-btn w-full bg-white text-zinc-950 px-8 py-4 rounded-xl font-black text-sm uppercase tracking-widest border border-zinc-300 hover:bg-zinc-100 transition-colors">
            ...
            <div className="machined-panel p-10 flex flex-col h-full bg-zinc-950 border-zinc-800 text-white relative overflow-hidden">
              ...
              <button className="magnetic-btn w-full bg-emerald-500 text-white px-8 py-4 rounded-xl font-black text-sm uppercase tracking-widest hover:bg-emerald-400 transition-colors relative z-10">
          ...
          <div className="max-w-4xl mx-auto">
            <div className="machined-panel p-12 md:p-24 text-center reveal-3d bg-white/80 shadow-2xl">
              ...
              <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
                <button
                  onClick={() => navigate('/dashboard')}
                  className="magnetic-btn bg-zinc-950 text-white px-10 py-5 rounded-xl font-black text-xs uppercase tracking-widest shadow-xl hover:bg-amber-400 transition-colors">
                  <span className="magnetic-btn-inner">Open Dashboard</span>
                </button>
                <button className="magnetic-btn bg-transparent border-2 border-zinc-300 text-zinc-900 px-10 py-5 rounded-xl font-black text-xs uppercase tracking-widest hover:bg-zinc-100 transition-colors">
